...
const Div1 = () => {
  ...
  {slides.map((slide) => (
    <div key={slide.id} className="flex">
      <div className="flex md:flex md:flex-row w-screen">
        ...
        <div className="right bg-sky-200 w-[65vw] h-[85vh] md:h-[75vh] relative">
          ...
          <div className="third md:my-10 md:mx-8 md:flex">
            <div className="desc md:w-1/3 mx-2 mr-14">
              ...
              <p className='text-xs md:text-lg leading-tight'>{slide.description}</p>
            </div>
            <div className="desc md:w-1/3 mx-2 mr-14">
              <p className='font-bold text-customPink md:text-2xl'>Details</p>
              <p className='text-xs md:text-lg leading-tight'>{slide.details}</p>
            </div>
          </div>
          <div onClick={() => { addToCart(slide.id, 1, slide.description, slide.price, slide.name, "S", "M", slide.image) }} className="bag absolute right-12 bottom-12 md:right-20 md:...">
        </div>
      </div>
    </div>
  </div>
